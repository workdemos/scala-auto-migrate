...
trait Tables {
   ...
   *  @param remark Database column remark DBType(VARCHAR), Length(25,true), Default(None)
   *  @param fundPoolId Database column fund_pool_id DBType(INT) */
  case class BalancecnyRow(id: Int, income: scala.math.BigDecimal, balance: scala.math.BigDecimal, balanceForCash: scala.math.BigDecimal, balanceForCredit: scala.math.BigDecimal, created: Int, userId: Int, userType: Byte, remark: Option[String] = None, fundPoolId: Int)
  /** GetResult implicit for fetching BalancecnyRow objects using plain SQL queries */
  implicit def GetResultBalancecnyRow(implicit e0: GR[Int], e1: GR[scala.math.BigDecimal], e2: GR[Byte], e3: GR[Option[String]]): GR[BalancecnyRow] = GR{
    prs => import prs._
    BalancecnyRow.tupled((<<[Int], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<[Int], <<[Int], <<[Byte], <<?[String], <<[Int]))
  }
  ...
  class Balancecny(_tableTag: Tag) extends Table[BalancecnyRow](_tableTag, "BalanceCny") {
    def * = (id, income, balance, balanceForCash, balanceForCredit, created, userId, userType, remark, fundPoolId) <> (BalancecnyRow.tupled, BalancecnyRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (id.?, income.?, balance.?, balanceForCash.?, balanceForCredit.?, created.?, userId.?, userType.?, remark, fundPoolId.?).shaped.<>({r=>import r._; _1.map(_=> BalancecnyRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9, _10.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column remark DBType(VARCHAR), Length(25,true), Default(None) */
    val remark: Column[Option[String]] = column[Option[String]]("remark", O.Length(25,varying=true), O.Default(None))
   ...
   *  @param userType Database column user_type DBType(TINYINT)
   *  @param remark Database column remark DBType(VARCHAR), Length(25,true), Default(None) */
  case class BalancejpyRow(id: Int, fundPoolId: Int, income: scala.math.BigDecimal, balance: scala.math.BigDecimal, created: Int, userId: Int, userType: Byte, remark: Option[String] = None)
  /** GetResult implicit for fetching BalancejpyRow objects using plain SQL queries */
  implicit def GetResultBalancejpyRow(implicit e0: GR[Int], e1: GR[scala.math.BigDecimal], e2: GR[Byte], e3: GR[Option[String]]): GR[BalancejpyRow] = GR{
    prs => import prs._
    BalancejpyRow.tupled((<<[Int], <<[Int], <<[scala.math.BigDecimal], <<[scala.math.BigDecimal], <<[Int], <<[Int], <<[Byte], <<?[String]))
  }
  ...
  class Balancejpy(_tableTag: Tag) extends Table[BalancejpyRow](_tableTag, "BalanceJpy") {
    def * = (id, fundPoolId, income, balance, created, userId, userType, remark) <> (BalancejpyRow.tupled, BalancejpyRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (id.?, fundPoolId.?, income.?, balance.?, created.?, userId.?, userType.?, remark).shaped.<>({r=>import r._; _1.map(_=> BalancejpyRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
   ...
   *  @param remark Database column remark DBType(VARCHAR), Length(25,true)
   *  @param creditReg Database column credit_reg DBType(BIT) */
  case class FundpoolRow(id: Int, income: scala.math.BigDecimal, amount: scala.math.BigDecimal, fundFrom: Byte, fundClass: Byte, orderId: Int, status: String, created: Int, finished: Int, freezed: Int, remark: String, creditReg: Boolean)
  ...
  class Fundpool(_tableTag: Tag) extends Table[FundpoolRow](_tableTag, "FundPool") {
    def * = (id, income, amount, fundFrom, fundClass, orderId, status, created, finished, freezed, remark, creditReg) <> (FundpoolRow.tupled, FundpoolRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (id.?, income.?, amount.?, fundFrom.?, fundClass.?, orderId.?, status.?, created.?, finished.?, freezed.?, remark.?, creditReg.?).shaped.<>({r=>import r._; _1.map(_=> FundpoolRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7.get, _8.get, _9.get, _10.get, _11.get, _12.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column remark DBType(VARCHAR), Length(25,true) */
    val remark: Column[String] = column[String]("remark", O.Length(25,varying=true))
    /** Database column credit_reg DBType(BIT) */
    val creditReg: Column[Boolean] = column[Boolean]("credit_reg")
  }
